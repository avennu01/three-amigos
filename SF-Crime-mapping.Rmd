...
ggmap(map_SF_1)  + 
  ...
  geom_point(data=walking_route_2[walking_route_2_hop_count,],  color="yellow", size=4) +
    geom_label(data=walking_route_2[walking_route_2_hop_count,], label="Painted Ladies", vjust=2, size=5)+
...
data_crime_routes <- rbind(dat_crime_route_1, dat_crime_route_2, dat_crime_route_3)
  #nrow(data_crime_routes)
  rm(dat_crime_route_1, dat_crime_route_2, dat_crime_route_3)
  #head(data_crime_routes)
  #three_path <- c("Destination", "Length_Actual", "Neighborhood_Crime_Count"")
